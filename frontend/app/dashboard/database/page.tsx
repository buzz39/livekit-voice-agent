        ...
        <div className="space-y-6 p-6">
            ...
            {!databaseUrl ? (
                <div className="bg-white border rounded-lg p-6 max-w-md">
                    <h2 className="text-xl font-semibold mb-4">Connect to Neon Database</h2>
                    ...
                    {message && (
                        <div className={`mt-3 p-2 rounded text-sm ${message.includes('error') ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                            {message}
                        </div>
                    )}
                </div>
                ...
                <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-600">Connected to Neon Database</p>
                            <p className="text-xs text-gray-500 mt-1 break-all">{databaseUrl.substring(0, 50)}...</p>
                        </div>
                        <button
                            onClick={() => {
                                setDatabaseUrl('');
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="lg:col-span-1">
                            <h2 className="font-semibold text-lg mb-3">Tables</h2>
                                ...
                                {tables.length === 0 ? (
                                    ...
                                    tables.map((table) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-xs text-gray-600">{table.rows.length} rows</div>
                                        </button>
                                    ))
                                )}
                            </div>
                        ...
                        <div className="lg:col-span-3">
                            {currentTable ? (
                                <div className="space-y-4">
                                    {/* Rows List */}
                                    <div>
                                        <h2 className="font-semibold text-lg mb-3">Rows</h2>
                                    ...
                                    {selectedRow !== null && (
                                        <div className="bg-white border rounded-lg p-6">
                                            <h3 className="text-lg font-semibold mb-4">Edit Row {selectedRow + 1}</h3>
